...
values ('clusteredScheduler', 'TASK_14', 'DEFAULT', '0 * * * * ?', 'Asia/Shanghai'),
...
values ('clusteredScheduler', 'TASK_14', 'DEFAULT', NULL, 'com.yami.shop.quartz.config.QuartzJob', '0', '1', '0', '0',
        ''),
...
values ('clusteredScheduler', 'TASK_14', 'DEFAULT', 'TASK_14', 'DEFAULT', NULL, 1669166100000, 1669166040000, 5,
        'WAITING', 'CRON', 1653270825000, 0, NULL, 1, ''),
       ('clusteredScheduler', 'TASK_16', 'DEFAULT', 'TASK_16', 'DEFAULT', NULL, 1669166100000, 1669165800000, 5,
        'WAITING', 'CRON', 1653270869000, 0, NULL, 1, '');
...
(
  ...
  AUTO_INCREMENT = 659006000001
  DEFAULT CHARSET = utf8;

/*Data for the table `tz_area` */

insert into `tz_area`(`area_id`, `area_name`, `parent_id`, `level`)
values (110000000000, '北京市', 0, 1),
...
insert into `tz_attach_file`(`file_id`, `file_path`, `file_type`, `file_size`, `upload_time`, `file_join_id`,
                             `file_join_type`)
values (1, '2019/07/6aeea212368e4796ad83e17381d62c38.png', 'png', 26409, '2019-07-01 17:26:44', NULL, NULL),
...
(
  ...
  AUTO_INCREMENT = 97
  DEFAULT CHARSET = utf8 COMMENT ='产品类目';

/*Data for the table `tz_category` */

insert into `tz_category`(`category_id`, `shop_id`, `parent_id`, `category_name`, `icon`, `pic`, `seq`, `status`,
                          `rec_time`, `grade`, `update_time`)
values (85, 1, 0, '手机数码', NULL, '2019/04/4f148d81d60941b695cb77370a073653.jpg', 1, 1, '2019-04-21 17:28:32', 0,
        '2019-04-27 11:22:09'),
       (87, 1, 0, '美妆护肤', NULL, '2019/04/84f1a591a9ed46f68d46eee55c130b34.jpg', 1, 1, '2019-04-21 17:30:45', 0,
        '2019-04-27 10:46:12'),
       (88, 1, 0, '运动服饰', NULL, '2019/04/68f081f04c2644319d882a8828f4741c.jpg', 1, 1, '2019-04-21 17:31:12', 0,
        '2019-04-27 10:38:31'),
       ...
       (95, 1, 0, '美味零食', NULL, '2019/04/3483eafc86674a74bcf9da6100769a9a.jpg', 1, 1, '2019-04-21 21:46:01', 0,
        '2019-04-27 11:23:27'),
...
(
  ...
  AUTO_INCREMENT = 30
  DEFAULT CHARSET = utf8 COMMENT ='物流公司';

/*Data for the table `tz_delivery` */

insert into `tz_delivery`(`dvy_id`, `dvy_name`, `company_home_url`, `rec_time`, `modify_time`, `query_url`)
values (14, '顺丰快递公司', 'http://www.sf-express.com', '2015-08-20 11:58:03', '2017-03-22 17:12:27',
        'http://www.kuaidi100.com/query?type=shunfeng&postid={dvyFlowId}&id=11'),
       (15, '申通快递公司', 'http://www.sto-express.com', '2015-08-20 11:58:24', '2015-08-20 12:04:23',
        'http://www.kuaidi100.com/query?type=shentong&postid={dvyFlowId}&id=11'),
       (16, '中通速递', 'http://www.zto.cn', '2015-08-20 11:58:48', '2015-08-20 12:04:31',
        'http://www.kuaidi100.com/query?type=zhongtong&postid={dvyFlowId}&id=11'),
       (17, '安信达', 'http://www.anxinda.com', '2015-12-22 10:19:33', '2015-12-22 10:37:26',
        'http://www.kuaidi100.com/query?type=anxindakuaixi&postid={dvyFlowId}&id=11'),
       (18, 'EMS', 'http://www.ems.com.cn', '2015-12-22 10:38:15', '2015-12-22 10:38:15',
        'http://www.kuaidi100.com/query?type=ems&postid={dvyFlowId}&id=11'),
       (19, '凡客如风达', 'http://www.rufengda.com', '2015-12-22 10:38:55', '2015-12-22 10:38:55',
        'http://www.kuaidi100.com/query?type=rufengda&postid={dvyFlowId}&id=11'),
       (20, '汇通快递', 'http://www.htky365.com', '2015-12-22 10:39:46', '2015-12-22 10:39:46',
        'http://www.kuaidi100.com/query?type=huitongkuaidi&postid={dvyFlowId}&id=11'),
       (21, '天天快递', 'http://www.ttkdex.com', '2015-12-22 10:40:44', '2015-12-22 10:40:44',
        'http://www.kuaidi100.com/query?type=tiantian&postid={dvyFlowId}&id=11'),
       (22, '佳吉快运', 'http://www.jiaji.com', '2015-12-22 10:42:55', '2015-12-22 10:42:55',
        'http://www.kuaidi100.com/query?type=jiajiwuliu&postid={dvyFlowId}&id=11'),
       (23, '速尔快递', 'http://www.sure56.com', '2015-12-22 10:43:35', '2015-12-22 10:43:35',
        'http://www.kuaidi100.com/query?type=suer&postid={dvyFlowId}&id=11'),
       (24, '信丰物流', 'http://www.xf-express.com.cn', '2015-12-22 10:44:17', '2015-12-22 10:44:17',
        'http://www.kuaidi100.com/query?type=xinfengwuliu&postid={dvyFlowId}&id=11'),
       (25, '韵达快递', 'http://www.yundaex.com', '2015-12-22 10:44:51', '2015-12-22 10:44:51',
        'http://www.kuaidi100.com/query?type=yunda&postid={dvyFlowId}&id=11'),
       (26, '优速快递', 'http://www.uc56.com', '2015-12-22 10:45:20', '2015-12-22 10:45:20',
        'http://www.kuaidi100.com/query?type=youshuwuliu&postid={dvyFlowId}&id=11'),
       (27, '中邮物流', 'http://www.cnpl.com.cn', '2015-12-22 10:45:58', '2015-12-22 10:45:58',
        'http://www.kuaidi100.com/query?type=zhongyouwuliu&postid={dvyFlowId}&id=11'),
       (28, '圆通快递', 'http://www.yto.net.cn', '2015-12-22 11:44:18', '2015-12-22 11:44:18',
        'http://www.kuaidi100.com/query?type=yuantong&postid={dvyFlowId}&id=11'),
       (29, '宅急送', 'http://www.zjs.com.cn', '2015-12-22 11:45:55', '2015-12-22 11:45:55',
        'http://www.kuaidi100.com/query?type=zhaijisong&postid={dvyFlowId}&id=11');
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='热搜';
...
(
  ...
  AUTO_INCREMENT = 6
  DEFAULT CHARSET = utf8 COMMENT ='主页轮播图';

/*Data for the table `tz_index_img` */

insert into `tz_index_img`(`img_id`, `shop_id`, `img_url`, `des`, `title`, `link`, `status`, `seq`, `upload_time`,
                           `relation`, `type`)
values (2, 1, '2019/04/f676a8a8dbcb4e5c9bc907ef059aedb9.jpg', '', NULL, NULL, 1, 1, '2018-12-20 15:22:19', 73, 0),
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='登录历史表';
...
insert into `tz_message`(`id`, `create_time`, `user_name`, `email`, `contact`, `content`, `reply`, `status`)
values (1, '2018-10-16 00:11:02', 'djr', '123456', 'nihao', '<p>aaaaaaqqqqffff</p>', '<p>??</p>', 0),
...
insert into `tz_order`(`order_id`, `shop_id`, `prod_name`, `user_id`, `order_number`, `total`, `actual_total`,
                       `pay_type`, `remarks`, `status`, `dvy_type`, `dvy_id`, `dvy_flow_id`, `freight_amount`,
                       `addr_order_id`, `product_nums`, `create_time`, `update_time`, `pay_time`, `dvy_time`,
                       `finally_time`, `cancel_time`, `is_payed`, `delete_status`, `refund_sts`, `reduce_amount`,
                       `order_type`, `close_type`)
values (1, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '51540df5255e4d22903b0f83921095ff',
        '1145634946149388288', 1.01, 1.01, 1, '', 5, NULL, 14, '123656347535245', 0.00, 1, 1, '2019-07-01 18:07:11',
        '2019-07-01 18:07:22', '2019-07-01 18:07:22', '2019-07-03 11:06:57', '2019-08-07 17:05:00', NULL, 1, 0, 0, 0.00,
        NULL, NULL),
       (2, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '51540df5255e4d22903b0f83921095ff',
        '1146346112622399488', 1.01, 1.01, NULL, '', 6, NULL, NULL, '', 0.00, 2, 1, '2019-07-03 17:13:06',
        '2019-07-03 17:13:06', NULL, NULL, NULL, '2019-07-03 17:17:46', 0, 2, 0, 0.00, NULL, NULL),
       (3, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 64GB ', '51540df5255e4d22903b0f83921095ff',
        '1146346762332672000', 7103.00, 7103.00, NULL, '', 6, NULL, NULL, '', 0.00, 3, 1, '2019-07-03 17:15:41',
        '2019-07-03 17:15:41', NULL, NULL, NULL, '2019-07-03 17:17:21', 0, 2, 0, 0.00, NULL, NULL),
       (4, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '51540df5255e4d22903b0f83921095ff',
        '1146346992126005248', 1.01, 1.01, NULL, '', 6, NULL, NULL, '', 0.00, 5, 1, '2019-07-03 17:16:36',
        '2019-07-03 17:16:36', NULL, NULL, NULL, '2019-07-03 17:17:17', 0, 2, 0, 0.00, NULL, NULL),
       (5, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '51540df5255e4d22903b0f83921095ff',
        '1146347329394184192', 1.01, 1.01, NULL, '', 6, NULL, NULL, '', 0.00, 6, 1, '2019-07-03 17:17:56',
        '2019-07-03 17:17:56', NULL, NULL, NULL, '2019-08-07 17:02:00', 0, 0, 0, 0.00, NULL, NULL);
...
insert into `tz_order_item`(`order_item_id`, `shop_id`, `order_number`, `prod_id`, `sku_id`, `prod_count`, `prod_name`,
                            `sku_name`, `pic`, `price`, `user_id`, `product_total_amount`, `rec_time`, `comm_sts`,
                            `distribution_card_no`, `basket_date`)
values (1, 1, '1145634946149388288', 18, 314, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '换修无忧版 深空灰色 64GB ',
        '2019/04/2cd9ec641d92458983c00d87ff33ad57.jpg', 1.01, '51540df5255e4d22903b0f83921095ff', 1.01,
        '2019-07-01 18:07:11', 0, NULL, '2019-07-01 18:05:54'),
       (2, 1, '1146346112622399488', 18, 314, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '换修无忧版 深空灰色 64GB ',
        '2019/04/2cd9ec641d92458983c00d87ff33ad57.jpg', 1.01, '51540df5255e4d22903b0f83921095ff', 1.01,
        '2019-07-03 17:13:06', 0, NULL, '2019-07-03 17:13:05'),
       (3, 1, '1146346762332672000', 18, 317, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 64GB ', '换修无忧版 银色 64GB ',
        '2019/04/eaa8c9bd3e7b41eaa310adbde10b6401.jpg', 7103.00, '51540df5255e4d22903b0f83921095ff', 7103.00,
        '2019-07-03 17:15:41', 0, NULL, '2019-07-03 17:15:40'),
       (4, 1, '1146346992126005248', 18, 314, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '换修无忧版 深空灰色 64GB ',
        '2019/04/2cd9ec641d92458983c00d87ff33ad57.jpg', 1.01, '51540df5255e4d22903b0f83921095ff', 1.01,
        '2019-07-03 17:16:36', 0, NULL, '2019-07-03 17:16:34'),
       (5, 1, '1146347329394184192', 18, 314, 1, 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', '换修无忧版 深空灰色 64GB ',
        '2019/04/2cd9ec641d92458983c00d87ff33ad57.jpg', 1.01, '51540df5255e4d22903b0f83921095ff', 1.01,
        '2019-07-03 17:17:56', 0, NULL, '2019-07-03 17:17:55');
...
insert into `tz_order_settlement`(`settlement_id`, `pay_no`, `biz_pay_no`, `order_number`, `pay_type`, `pay_type_name`,
                                  `pay_amount`, `is_clearing`, `user_id`, `create_time`, `clearing_time`, `version`,
                                  `pay_status`)
values (1, '1145634947151826944', NULL, '1145634946149388288', 1, NULL, 1.01, 0, '51540df5255e4d22903b0f83921095ff',
        '2019-07-01 18:07:11', NULL, 1, 1),
       (2, '1146346113691947008', NULL, '1146346112622399488', 1, NULL, 1.01, 0, '51540df5255e4d22903b0f83921095ff',
        '2019-07-03 17:13:06', NULL, 0, 0),
       (3, '1146346763158949888', NULL, '1146346762332672000', 1, NULL, 7103.00, 0, '51540df5255e4d22903b0f83921095ff',
        '2019-07-03 17:15:41', NULL, 0, 0),
       (4, '1146346992977448960', NULL, '1146346992126005248', 1, NULL, 1.01, 0, '51540df5255e4d22903b0f83921095ff',
        '2019-07-03 17:16:36', NULL, 0, 0),
       (5, '1146347417931747328', NULL, '1146347329394184192', 1, NULL, 1.01, 0, '51540df5255e4d22903b0f83921095ff',
        '2019-07-03 17:17:56', NULL, 0, 0);
...
insert into `tz_pick_addr`(`addr_id`, `addr_name`, `addr`, `mobile`, `province_id`, `province`, `city_id`, `city`,
                           `area_id`, `area`, `shop_id`)
values (1, '测试', '大学城附近', '18888888888', 440000000000, '广东省', 440100000000, '广州市', 440113000000, '番禺区', 1);
...
insert into `tz_prod`(`prod_id`, `prod_name`, `shop_id`, `ori_price`, `price`, `brief`, `content`, `pic`, `imgs`,
                      `status`, `category_id`, `sold_num`, `total_stocks`, `delivery_mode`, `delivery_template_id`,
                      `create_time`, `update_time`, `putaway_time`, `version`)
values (18, 'Apple iPhone XS Max 移动联通电信4G手机 ', 1, 0.00, 1.01, '6.5英寸大屏，支持双卡。',
        '<div style=\"margin: 0px; padding: 0px; color: #666666; font-family: tahoma, arial, \'Microsoft YaHei\', \'Hiragino Sans GB\', u5b8bu4f53, sans-serif; font-size: 12px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: #ffffff; text-decoration-style: initial; text-decoration-color: initial;\" align=\"center\">\n<table id=\"__01\" style=\"text-align: center;\" border=\"0\" width=\"750\" cellspacing=\"0\" cellpadding=\"0\">\n<tbody>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img30.360buyimg.com/cms/jfs/t1/4626/32/3475/220504/5b997365E80a1373f/279c244f12161cb3.jpg\" alt=\"\" width=\"750\" height=\"1991\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img12.360buyimg.com/cms/jfs/t1/3397/21/3533/236322/5b99759aE73795787/f782e04a140c8f16.jpg\" alt=\"\" width=\"750\" height=\"2052\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img11.360buyimg.com/cms/jfs/t1/5274/3/3465/245167/5b997365E16b81bc9/93e07e40f3af5e62.jpg\" alt=\"\" width=\"750\" height=\"2250\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img30.360buyimg.com/cms/jfs/t1/2322/11/3524/269574/5b997365E26f81a7a/e01fc9486da9eda1.jpg\" alt=\"\" width=\"750\" height=\"2327\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img13.360buyimg.com/cms/jfs/t1/5074/21/3432/296470/5b997364Ee966f7a0/7f424d41479db45d.jpg\" alt=\"\" width=\"750\" height=\"2561\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img13.360buyimg.com/cms/jfs/t1/5770/18/3580/288371/5b997365Ea2c58cb4/176b9a40ccd4e56b.jpg\" alt=\"\" width=\"750\" height=\"2668\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img11.360buyimg.com/cms/jfs/t1/227/21/3811/268132/5b997364E3d6c51b2/92d2a3a559e3baa8.jpg\" alt=\"\" width=\"750\" height=\"2850\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img20.360buyimg.com/cms/jfs/t1/3787/5/3493/125020/5b997363E3c9f5910/ddbd08a556744630.jpg\" alt=\"\" width=\"750\" height=\"1486\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img30.360buyimg.com/cms/jfs/t1/1687/5/3327/266718/5b997366E9cc80e69/9e40ceae1fef4466.jpg\" alt=\"\" width=\"750\" height=\"3376\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img30.360buyimg.com/cms/jfs/t1/457/6/3849/283318/5b997363E0c5ab7a9/6f636f0a286bc87c.jpg\" alt=\"\" width=\"750\" height=\"2455\" /></td>\n</tr>\n<tr>\n<td><img class=\"\" style=\"margin: 0px; padding: 0px; border: 0px; vertical-align: middle;\" src=\"https://img10.360buyimg.com/cms/jfs/t1/397/25/3796/217624/5b9975a8E5ee578af/4d8f05a606fa5c4a.jpg\" alt=\"\" width=\"750\" height=\"2703\" /></td>\n</tr>\n</tbody>\n</table>\n</div>',
        '2019/04/eaa8c9bd3e7b41eaa310adbde10b6401.jpg', '2019/04/eaa8c9bd3e7b41eaa310adbde10b6401.jpg', 1, 93, NULL, 96,
        '{
          \"hasUserPickUp\": false,
          \"hasShopDelivery\": true
        }', 47, '2019-03-29 14:40:00', '2019-06-22 18:28:32', '2019-06-22 18:28:32', 85),
       (59, '兰蔻粉水清滢柔肤水400ml 爽肤水女保湿舒缓滋润嫩肤', 1, 0.00, 420.00, '好看耐穿',
        '<p><img src=\"http://img-test.gz-yami.com/2019/04/71f54ee20ef34872b1e0aa53cb75b7b6.jpg\" alt=\"\" width=\"790\" height=\"1110\" /></p>',
        '2019/04/ce5a32005a7a4f9483a17051bda6bd6c.jpg',
        '2019/04/ce5a32005a7a4f9483a17051bda6bd6c.jpg,2019/04/8a8712b81a2d4f4ca3eb4a725ad229c6.jpg', 1, 87, NULL, 0, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 48, '2019-04-21 19:15:34', '2019-04-29 14:30:44', '2019-04-29 14:30:44', NULL),
       (68, '【Dole都乐】菲律宾都乐非转基因木瓜1只 单只约410g', 1, 0.00, 26.00, '包邮 肉厚籽少 独具风味',
        '<p style=\"text-align: justify;\"><img src=\"http://img-test.gz-yami.com/2019/04/e7536a53a83d450e8635ce1e9819faf6.jpg\" alt=\"\" width=\"790\" height=\"350\" /></p>',
        '2019/04/0bfd73f43d764d20b2f0b92813abdc56.jpg',
        '2019/04/0bfd73f43d764d20b2f0b92813abdc56.jpg,2019/04/355020f27acd4b13a652cb830f03bedc.jpg', 1, 95, NULL, 0, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-04-21 21:56:38', '2019-05-22 10:30:37', '2019-05-22 10:30:37', NULL),
       (69, '阿迪达斯官方 adidas 三叶草 NITE JOGGER 男子经典鞋BD7956', 1, 10.00, 1199.00, ' 运动鞋/休闲鞋',
        '<p><img src=\"http://img-test.gz-yami.com/2019/04/6d0bea4a0be54423999136bcd1158897.jpg\" alt=\"\" width=\"790\" height=\"2232\" /></p>',
        '2019/04/b3558ee506fb4589bfaa94a543226477.jpg',
        '2019/04/b3558ee506fb4589bfaa94a543226477.jpg,2019/04/df052ea31d3149fdb5c54f7c4fc6349b.jpg', 0, 88, NULL, 0, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-04-21 22:10:04', '2019-05-23 20:17:03', '2019-05-22 13:37:26', NULL),
       (70, '【Dole都乐】比利时Truval啤梨12只 进口水果新鲜梨 单果120g左右', 1, 0.00, 38.00, '好吃',
        '<p><img src=\"http://img-test.gz-yami.com/2019/04/67ce2251e9b14ea08b87752ef7b30207.jpg\" alt=\"\" width=\"760\" height=\"488\" /></p>',
        '2019/04/de0edd2aaf2d4d3c8b6c3fdfde738805.jpg',
        '2019/04/de0edd2aaf2d4d3c8b6c3fdfde738805.jpg,2019/04/ee4530e364ca48869347e1e79915406c.jpg', 1, 95, NULL, 15, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-04-22 16:43:33', '2019-06-22 09:40:24', '2019-06-22 09:40:24', NULL),
       (71, '旗舰店官网 自拍神器 梵高定制', 1, 10.00, 6998.00, '梵高定制礼盒 全球限量发售 分期免息',
        '<p><img src=\"http://img-test.gz-yami.com/2019/04/fa35b300102e45f3a57d7c5c775ebf6d.jpg\" alt=\"\" width=\"790\" height=\"853\" /></p>\n<p><img src=\"http://img-test.gz-yami.com/2019/04/f8fd168ddb8a437dbb5b742691bd1d02.jpg\" alt=\"\" width=\"800\" height=\"800\" /><img src=\"http://img-test.gz-yami.com/2019/04/db46108466264b48841b18437940e0b3.jpg\" alt=\"\" width=\"800\" height=\"800\" /></p>',
        '2019/04/667e4ce211b44c6da10891f42927fc11.jpg',
        '2019/04/667e4ce211b44c6da10891f42927fc11.jpg,2019/04/31c416e7020b4fe69d491bc09baaae90.jpg', 1, 85, NULL, 99, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-04-23 15:43:26', '2019-05-21 11:01:59', '2019-05-21 11:01:59', NULL),
       (72, '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭', 1, 0.00, 169.00, '创意餐厅装饰画 好好吃饭',
        '<p><img src=\"http://img-test.gz-yami.com/2019/04/dca352cc3b0a438e95509f2cf54860de.jpg\" alt=\"\" width=\"790\" height=\"1282\" /></p>',
        '2019/04/299df42b0b404c338060aef5b1b11dd7.jpg',
        '2019/04/299df42b0b404c338060aef5b1b11dd7.jpg,2019/04/bca5ff8e257f4db6aa0be42ed4393568.jpg', 1, 91, NULL, 0, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-04-25 10:22:21', '2019-04-29 14:29:25', '2019-04-29 14:29:25', NULL),
       (73, '阴阳师寮办秘制 月见和菓子 184克', 1, 0.00, 22.00, '三层夹心，Q弹有料',
        '<p><img src=\"http://img-test.gz-yami.com/2019/04/77f70d0c32c44294a2c80273262fa5fc.jpg\" alt=\"\" width=\"750\" height=\"750\" /></p>',
        '2019/04/60c6300596504c10bd80d6365647b078.jpg',
        '2019/04/60c6300596504c10bd80d6365647b078.jpg,2019/04/11175723eae8431cabda164e0e197cb1.jpg', 1, 95, NULL, 77, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-04-27 11:37:13', '2019-05-21 13:56:10', '2019-05-21 13:56:10', NULL),
       (74, '旺仔牛奶', 2, 0.00, 100.00, '测试', '<p>测试商品</p>', '2019/05/b1a4bf7612554dbc8395f22e22d531c8.jpg',
        '2019/05/b1a4bf7612554dbc8395f22e22d531c8.jpg', 1, 95, NULL, 0, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 48, '2019-05-22 10:39:49', '2019-05-22 10:39:49', '2019-05-22 10:39:49', NULL),
       (75, '测试商品A', 1, 30.00, 30.00, '', '<p>测试</p>', '2019/05/65525bbccee04ec5a094f38ce61d6b86.jpg',
        '2019/05/65525bbccee04ec5a094f38ce61d6b86.jpg', 1, 95, NULL, 30, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-05-23 17:23:11', '2019-06-22 09:40:13', '2019-06-22 09:40:13', NULL),
       (76, '测试商品B', 1, 40.00, 40.00, 'BBBB', '<p>测试</p>', '2019/05/150d6c4a46914dbfa82690098b2ec4e7.jpg',
        '2019/05/150d6c4a46914dbfa82690098b2ec4e7.jpg', 1, 95, NULL, 40, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-05-23 17:24:06', '2019-06-22 09:40:06', '2019-06-22 09:40:06', NULL),
       (77, '测试商品C', 1, 60.00, 50.00, 'CCC', '<p>CCCC</p>', '2019/05/1bdd097dbffd477799a7aca949377b20.jpg',
        '2019/05/1bdd097dbffd477799a7aca949377b20.jpg', 1, 95, NULL, 50, '{
         \"hasUserPickUp\": false,
         \"hasShopDelivery\": true
       }', 47, '2019-05-23 17:24:48', '2019-06-22 09:39:59', '2019-06-22 09:39:59', NULL);
...
insert into `tz_prod_prop`(`prop_id`, `prop_name`, `rule`, `shop_id`)
values (80, '内存', 1, 1),
       (81, '颜色', 1, 1);
...
insert into `tz_prod_prop_value`(`value_id`, `prop_value`, `prop_id`)
values (381, '32G', 80),
       (382, '64G', 80),
       (383, '128G', 80),
       (384, '红', 81),
...
(
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8 COMMENT ='商品分组表';

/*Data for the table `tz_prod_tag` */

insert into `tz_prod_tag`(`id`, `title`, `shop_id`, `status`, `is_default`, `prod_count`, `style`, `seq`, `create_time`,
                          `update_time`, `delete_time`)
values (1, '每日上新', 1, 1, 0, 0, 2, 3, '2019-04-18 14:27:02', '2019-04-18 14:27:06', NULL),
...
insert into `tz_prod_tag_reference`(`reference_id`, `shop_id`, `tag_id`, `prod_id`, `status`, `create_time`)
values (25, 1, 1, 60, 1, '2019-04-21 21:29:19'),
...
insert into `tz_schedule_job`(`job_id`, `bean_name`, `method_name`, `params`, `cron_expression`, `status`, `remark`,
                              `create_time`)
values (14, 'orderTask', 'cancelOrder', '', '0 * * * * ?', 0, '取消超时未支付订单', '2019-06-24 14:51:51'),
...
insert into `tz_schedule_job_log`(`log_id`, `job_id`, `bean_name`, `method_name`, `params`, `status`, `error`, `times`,
                                  `create_time`)
values (1, 14, 'orderTask', 'cancelOrder', '', 1, NULL, 57, '2019-08-07 17:02:00'),
...
insert into `tz_shop_detail`(`shop_id`, `shop_name`, `user_id`, `shop_type`, `intro`, `shop_notice`, `shop_industry`,
                             `shop_owner`, `mobile`, `tel`, `shop_lat`, `shop_lng`, `shop_address`, `province`, `city`,
                             `area`, `pca_code`, `shop_logo`, `shop_photos`, `open_time`, `shop_status`,
                             `transport_type`, `fixed_freight`, `full_free_shipping`, `create_time`, `update_time`,
                             `is_distribution`)
values (1, 'mall4j小店1', NULL, NULL, 'mall4j小店 爱你哟', NULL, NULL, NULL, NULL, '020-123456', NULL, NULL, '大学城北', '广东省',
        '广州市', '番禺区', '44/4401/440113', '2018/08/78a6a63cf02d4965912bc5047f49afa0.jpg',
        '2018/08/c7a50f443a85462d8129d83cf0f7eb91.jpg,2018/08/79791fc749444ef1ab4d2ca56fe9363f.jpg',
        '00:00:00 - 00:20:00', 1, NULL, NULL, NULL, '2018-08-30 11:10:05', NULL, 1),
       (2, 'mall4j大店2', NULL, NULL, 'mall4j大店 店大大', NULL, NULL, NULL, NULL, '010-123456', NULL, NULL, '天安门哟', '北京市',
        '市辖区', '东城区', '11/1101/110101', '2018/08/0907446e05c44431be5d27ec7c277ee6.jpg',
        '2018/08/5f97fc62c18d4d2292f8101fa0291e85.jpg', '06:00:00 - 00:00:00', 1, NULL, NULL, NULL,
        '2018-08-31 10:16:06', NULL, NULL),
       (3, 'mall4j3', NULL, NULL, 'mall4j 店铺描述', NULL, NULL, NULL, NULL, '010-211111111', NULL, NULL, '大学城北', '天津市',
        '市辖区', '和平区', '12/1201/120101', '2018/09/4bb8b326f85a4c6aad251c561a17f0c4.png',
        '2018/09/63c3d47beb5544f9b30103721002ca2e.jpg,2018/09/899e1ebf3c6c467d8d8630a3c18720db.jpg',
        '00:02:00 - 00:00:00', 1, NULL, NULL, NULL, '2018-09-06 18:50:00', '2018-09-29 09:50:05', NULL);
...
(
  ...
  AUTO_INCREMENT = 405
  DEFAULT CHARSET = utf8 COMMENT ='单品SKU表';

/*Data for the table `tz_sku` */

insert into `tz_sku`(`sku_id`, `prod_id`, `properties`, `ori_price`, `price`, `stocks`, `actual_stocks`, `update_time`,
                     `rec_time`, `party_code`, `model_id`, `pic`, `sku_name`, `prod_name`, `version`, `weight`,
                     `volume`, `status`, `is_delete`)
values (10, 4, NULL, NULL, 0.10, 0, 100, '2019-05-14 10:00:41', '2018-09-14 14:05:52', NULL, NULL, NULL, '', NULL, 10,
        NULL, NULL, 1, NULL),
       (116, 13, '面积:75m²', 25000000.00, 25.00, 2, 200, '2018-11-22 11:42:59', '2018-11-22 11:42:59', '100001', NULL,
        '2018/11/d9316669736f48f7bd047a928e3b2972.jpg', '75m² ', '房子 75m² ', 0, 0, 0, 1, 1),
       (117, 15, '', 0.00, 0.00, 0, 0, '2018-11-22 15:20:53', '2018-11-22 15:20:53', '', NULL, NULL, '', '', 0, 0, 0, 1,
        1),
       (118, 16, '', 0.00, 0.00, 0, 0, '2018-11-22 15:21:22', '2018-11-22 15:21:22', '', NULL, NULL, '', '', 0, 0, 0, 1,
        1),
       (119, 17, '', 0.00, 0.00, 0, 0, '2018-11-22 15:21:34', '2018-11-22 15:21:34', '', NULL, NULL, '', '', 0, 0, 0, 1,
        1),
       (120, 18, '版本:公开版;颜色:金色;内存:64GB', 10999.00, 10999.00, 3, 3, '2018-12-29 13:48:46', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 64GB ', 3, 0, 0, 1, 1),
       (121, 18, '版本:换修无忧版;颜色:金色;内存:64GB', 10999.00, 10999.00, 5, 6, '2018-12-10 14:47:51', '2018-11-22 16:02:41', '',
        NULL, NULL, '换修无忧版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 64GB ', 1, 0, 0, 1, 1),
       (122, 18, '版本:原厂延保版;颜色:金色;内存:64GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '原厂延保版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 金色 64GB ', 0, 0, 0, 1, 1),
       (123, 18, '版本:公开版;颜色:深空灰色;内存:64GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 深空灰色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 64GB ', 0, 0, 0, 1, 1),
       (124, 18, '版本:换修无忧版;颜色:深空灰色;内存:64GB', 10999.00, 10999.00, 100, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41',
        '', NULL, NULL, '换修无忧版 深空灰色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', 0, 0, 0, 1, 1),
       (125, 18, '版本:原厂延保版;颜色:深空灰色;内存:64GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '原厂延保版 深空灰色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 深空灰色 64GB ', 0, 0, 0, 1, 1),
       (126, 18, '版本:公开版;颜色:银色;内存:64GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 银色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 银色 64GB ', 0, 0, 0, 1, 1),
       (127, 18, '版本:换修无忧版;颜色:银色;内存:64GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '换修无忧版 银色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 64GB ', 0, 0, 0, 1, 1),
       (128, 18, '版本:原厂延保版;颜色:银色;内存:64GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '原厂延保版 银色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 银色 64GB ', 0, 0, 0, 1, 1),
       (129, 18, '版本:公开版;颜色:金色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 金色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 256GB ', 0, 0, 0, 1, 1),
       (130, 18, '版本:换修无忧版;颜色:金色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '换修无忧版 金色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 256GB ', 0, 0, 0, 1, 1),
       (131, 18, '版本:原厂延保版;颜色:金色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '原厂延保版 金色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 金色 256GB ', 0, 0, 0, 1, 1),
       (132, 18, '版本:公开版;颜色:深空灰色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 深空灰色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 256GB ', 0, 0, 0, 1, 1),
       (133, 18, '版本:换修无忧版;颜色:深空灰色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41',
        '', NULL, NULL, '换修无忧版 深空灰色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 256GB ', 0, 0, 0, 1, 1),
       (134, 18, '版本:原厂延保版;颜色:深空灰色;内存:256GB', 10999.00, 10999.00, 107, 100, '2019-05-16 11:30:31',
        '2018-11-22 16:02:41', '', NULL, NULL, '原厂延保版 深空灰色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 深空灰色 256GB ',
        27, 0, 0, 1, 1),
       (135, 18, '版本:公开版;颜色:银色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 银色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 银色 256GB ', 0, 0, 0, 1, 1),
       (136, 18, '版本:换修无忧版;颜色:银色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '换修无忧版 银色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 256GB ', 0, 0, 0, 1, 1),
       (137, 18, '版本:原厂延保版;颜色:银色;内存:256GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '原厂延保版 银色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 银色 256GB ', 0, 0, 0, 1, 1),
       (138, 18, '版本:公开版;颜色:金色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 金色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 512GB ', 0, 0, 0, 1, 1),
       (139, 18, '版本:换修无忧版;颜色:金色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '换修无忧版 金色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 512GB ', 0, 0, 0, 1, 1),
       (140, 18, '版本:原厂延保版;颜色:金色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '原厂延保版 金色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 金色 512GB ', 0, 0, 0, 1, 1),
       (141, 18, '版本:公开版;颜色:深空灰色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 深空灰色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 512GB ', 0, 0, 0, 1, 1),
       (142, 18, '版本:换修无忧版;颜色:深空灰色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41',
        '', NULL, NULL, '换修无忧版 深空灰色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 512GB ', 0, 0, 0, 1, 1),
       (143, 18, '版本:原厂延保版;颜色:深空灰色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41',
        '', NULL, NULL, '原厂延保版 深空灰色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 深空灰色 512GB ', 0, 0, 0, 1, 1),
       (144, 18, '版本:公开版;颜色:银色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '公开版 银色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 银色 512GB ', 0, 0, 0, 1, 1),
       (145, 18, '版本:换修无忧版;颜色:银色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '换修无忧版 银色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 512GB ', 0, 0, 0, 1, 1),
       (146, 18, '版本:原厂延保版;颜色:银色;内存:512GB', 10999.00, 10999.00, 0, 0, '2018-11-22 16:02:41', '2018-11-22 16:02:41', '',
        NULL, NULL, '原厂延保版 银色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 银色 512GB ', 0, 0, 0, 1, 1),
       (256, 59, '', 0.00, 0.00, 0, 0, '2019-04-21 19:15:35', '2019-04-21 19:15:35', '', NULL, NULL, '', '安踏运动鞋', 0, 0,
        0, 1, 1),
       (257, 59, '颜色:深空灰色', 999.00, 100.00, 89, 89, '2019-04-21 19:49:37', '2019-04-21 19:49:37', '123187', NULL,
        '2019/04/16c40e0a9a2c403e8fa64af68f46e330.jpg', '深空灰色 ', '安踏运动鞋', 0, 287, 899, 1, 1),
       (258, 18, '版本:公开版', 19999.00, 12999.00, 999, 999, '2019-04-21 20:35:38', '2019-04-21 20:35:38', '123123412',
        NULL, '2019/04/5efab0e2610a484c925e3ec9a47719d1.jpg', '公开版 ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 ', 0, 213,
        331, 1, 1),
       (259, 18, '版本:换修无忧版', 13412.00, 12312.00, 232, 211, '2019-04-21 20:35:38', '2019-04-21 20:35:38', '1142411241',
        NULL, '2019/04/4f4db61a05044458bf4d08fdce497f47.jpg', '换修无忧版 ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 ', 0,
        123, 232, 1, 1),
       (260, 60, '颜色:金色', 299.00, 199.00, 233, 233, '2019-04-21 21:29:19', '2019-04-21 21:29:19', '1312151235', NULL,
        '2019/04/1be7d4e321f24c188bb694c50dc37a8e.jpg', '金色 ', '休闲鞋 底板', 0, 123, 243, 1, 1),
       (261, 61, '颜色:深空灰色', 100.00, 100.00, 23, 23, '2019-04-21 21:33:33', '2019-04-21 21:33:33', '', NULL,
        '2019/04/3c547f3855f94894bd1058286eecb8d9.jpg', '深空灰色 ', '爆款女装T恤青春', 0, 0, 0, 1, 1),
       (262, 62, '颜色:金色', 400.00, 358.00, 122, 122, '2019-04-21 21:35:13', '2019-04-21 21:35:13', '', NULL,
        '2019/04/0cabb44de08345e2b5db9c9ea98ef1f3.jpg', '金色 ', '工装裤', 0, 0, 0, 1, 1),
       (263, 63, '版本:公开版', 233.00, 233.00, 43, 34, '2019-04-21 21:37:21', '2019-04-21 21:37:21', '', NULL,
        '2019/04/b98a528660e84cf680c5098992d77bf9.jpg', '公开版 ', '公文包', 0, 0, 0, 1, 1),
       (264, 64, '', 234.00, 233.00, 234, 234, '2019-04-21 21:48:11', '2019-04-21 21:48:11', '', NULL, NULL, '', '美味曲奇',
        0, 0, 0, 1, 1),
       (265, 65, '', 13.00, 10.00, 345, 345, '2019-04-21 21:50:23', '2019-04-21 21:50:23', '', NULL, NULL, '', '大大口香糖',
        0, 0, 0, 1, 1),
       (266, 66, '', 14.00, 12.00, 574, 574, '2019-04-21 21:52:10', '2019-04-21 21:52:10', '', NULL, NULL, '', '乐事', 0,
        0, 0, 1, 1),
       (267, 67, '', 65.00, 54.00, 346, 344, '2019-04-21 21:54:20', '2019-04-21 21:54:20', '', NULL, NULL, '', '旺仔牛奶',
        0, 0, 0, 1, 1),
       (268, 68, '', 12.00, 26.00, 65, 65, '2019-04-21 21:56:39', '2019-04-21 21:56:39', '', NULL, NULL, '',
        '【Dole都乐】菲律宾都乐非转基因木瓜1只 单只约410g', 0, 0, 0, 1, 0),
       (269, 69, '版本:公开版', 3799.00, 3599.00, 239, 239, '2019-04-21 22:10:05', '2019-04-21 22:10:05', '', NULL,
        '2019/04/44cbf97dea4c45cda2a374d575568698.jpg', '公开版 ', '华为P30', 0, 0, 0, 1, 1),
       (270, 18, '版本:公开版', 0.00, 0.00, 0, 0, '2019-04-22 10:33:51', '2019-04-22 10:33:51', '', NULL, NULL, '', '', 0, 0,
        0, 0, 1),
       (271, 18, '版本:换修无忧版', 0.00, 0.00, 0, 0, '2019-04-22 10:33:51', '2019-04-22 10:33:51', '', NULL, NULL, '', '', 0,
        0, 0, 1, 1),
       (272, 70, '', 2.00, 1.00, 20, NULL, '2019-04-22 16:42:57', '2019-04-22 16:42:57', NULL, NULL, NULL, '', '面包面包',
        0, 0.1, 0.3, 1, 1),
       (273, 70, '', 3.00, 2.00, 4, NULL, '2019-04-22 17:55:09', '2019-04-22 17:55:09', NULL, NULL, NULL, '', '面包面包', 0,
        5, 6, 1, 1),
       (274, 70, '', 2.00, 1.00, 3, NULL, '2019-04-22 17:57:00', '2019-04-22 17:57:00', NULL, NULL, NULL, '', '面包面包', 0,
        4, 5, 1, 1),
       (275, 71, '颜色:金色', 20.00, 10.00, 999, NULL, '2019-04-23 15:43:25', '2019-04-23 15:43:25', NULL, NULL, NULL, '',
        '红豆糕点', 0, 10, 1, 1, 1),
       (276, 70, '', 0.00, 0.00, 0, NULL, '2019-04-23 15:49:01', '2019-04-23 15:49:01', NULL, NULL, NULL, '', '面包面包', 0,
        0, 0, 1, 1),
       (277, 59, '颜色:深空灰色', 0.00, 0.00, 0, NULL, '2019-04-24 08:44:28', '2019-04-24 08:44:28', NULL, NULL, NULL,
        '深空灰色 ', '安踏运动鞋', 0, 0, 0, 1, 1),
       (278, 59, '颜色:深空灰色', 0.00, 0.00, 0, NULL, '2019-04-24 08:44:58', '2019-04-24 08:44:58', NULL, NULL, NULL,
        '深空灰色 ', '安踏运动鞋', 0, 0, 0, 1, 1),
       (279, 70, '', 2.00, 1.00, 3, NULL, '2019-04-24 18:04:01', '2019-04-24 18:04:01', NULL, NULL, NULL, '', '面包面包', 0,
        4, 5, 0, 1),
       (282, 71, '颜色:金色', 20.00, 10.00, 999, NULL, '2019-04-25 10:17:17', '2019-04-25 10:17:17', NULL, NULL,
        '2019/04/de38ac60fa5c4798bf6ed3c1c6403e34.jpg', '金色 ', '红豆糕点', 0, 0.1, 1, 1, 1),
       (283, 72, '颜色:金色', 1.00, 5.00, 999, NULL, '2019-04-25 10:22:20', '2019-04-25 10:22:20', NULL, NULL,
        '2019/04/5bbffdf1f3674a6d942319432ab4bc79.jpg', '', '快乐汽水', 0, 0.2, 0.3, 1, 1),
       (284, 71, '颜色:金色', 0.00, 0.00, 0, NULL, '2019-04-25 10:28:21', '2019-04-25 10:28:21', NULL, NULL, NULL, '金色 ',
        '红豆糕点', 0, 0, 0, 1, 1),
       (285, 72, '颜色:金色', 0.00, 0.00, 0, NULL, '2019-04-25 10:29:11', '2019-04-25 10:29:11', NULL, NULL, NULL, '金色 ',
        '快乐汽水', 0, 0, 0, 1, 1),
       (286, 72, '颜色:金色', 0.00, 0.00, 0, NULL, '2019-04-25 10:30:11', '2019-04-25 10:30:11', NULL, NULL, NULL, '金色 ',
        '快乐汽水', 0, 0, 0, 1, 1),
       (287, 72, '颜色:金色', 0.00, 0.00, 0, NULL, '2019-04-25 10:30:41', '2019-04-25 10:30:41', NULL, NULL, NULL, '金色 ',
        '快乐汽水', 0, 0, 0, 1, 1),
       (288, 18, '版本:公开版', 0.00, 0.00, 100, NULL, '2019-04-25 19:08:32', '2019-04-25 19:08:32', NULL, NULL, NULL,
        '公开版 ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 ', 0, 0, 0, 1, 1),
       (289, 18, '版本:换修无忧版', 0.00, 0.00, 99, NULL, '2019-04-25 19:08:32', '2019-04-25 19:08:32', NULL, NULL, NULL,
        '换修无忧版 ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 ', 0, 0, 0, 1, 1),
       (290, 18, '版本:公开版;颜色:金色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL, NULL,
        NULL, '', '', 0, 0, 0, 1, 1),
       (291, 18, '版本:换修无忧版;颜色:金色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL,
        NULL, NULL, '', '', 0, 0, 0, 1, 1),
       (292, 18, '版本:公开版;颜色:深空灰色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL,
        NULL, NULL, '', '', 0, 0, 0, 1, 1),
       (293, 18, '版本:换修无忧版;颜色:深空灰色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL,
        NULL, NULL, '', '', 0, 0, 0, 1, 1),
       (294, 18, '版本:公开版;颜色:金色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL, NULL,
        NULL, '', '', 0, 0, 0, 1, 1),
       (295, 18, '版本:换修无忧版;颜色:金色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL,
        NULL, NULL, '', '', 0, 0, 0, 1, 1),
       (296, 18, '版本:公开版;颜色:深空灰色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL,
        NULL, NULL, '', '', 0, 0, 0, 1, 1),
       (297, 18, '版本:换修无忧版;颜色:深空灰色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:08:51', '2019-04-26 11:08:51', NULL,
        NULL, NULL, '', '', 0, 0, 0, 1, 1),
       (298, 18, '版本:公开版;颜色:金色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL, NULL,
        NULL, '公开版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 64GB ', 0, 0, 0, 1, 1),
       (299, 18, '版本:换修无忧版;颜色:金色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL,
        NULL, NULL, '换修无忧版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 64GB ', 0, 0, 0, 1, 1),
       (300, 18, '版本:公开版;颜色:深空灰色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL,
        NULL, NULL, '公开版 深空灰色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 64GB ', 0, 0, 0, 1, 1),
       (301, 18, '版本:换修无忧版;颜色:深空灰色;内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL,
        NULL, NULL, '换修无忧版 深空灰色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', 0, 0, 0, 1, 1),
       (302, 18, '版本:公开版;颜色:金色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL, NULL,
        NULL, '公开版 金色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 256GB ', 0, 0, 0, 1, 1),
       (303, 18, '版本:换修无忧版;颜色:金色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL,
        NULL, NULL, '换修无忧版 金色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 256GB ', 0, 0, 0, 1, 1),
       (304, 18, '版本:公开版;颜色:深空灰色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL,
        NULL, NULL, '公开版 深空灰色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 256GB ', 0, 0, 0, 1, 1),
       (305, 18, '版本:换修无忧版;颜色:深空灰色;内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:19:48', '2019-04-26 11:19:48', NULL,
        NULL, NULL, '换修无忧版 深空灰色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 256GB ', 0, 0, 0, 1, 1),
       (306, 18, '内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:26:28', '2019-04-26 11:26:28', NULL, NULL, NULL,
        '64GB ', 'Apple iPhone XS Max eeeeee移动联通电信4G手机  64GB ', 0, 0, 0, 1, 1),
       (307, 18, '内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:26:28', '2019-04-26 11:26:28', NULL, NULL, NULL,
        '256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  256GB ', 0, 0, 0, 1, 1),
       (308, 18, '内存:64GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:26:47', '2019-04-26 11:26:47', NULL, NULL, NULL,
        '64GB ', 'Apple iPhone XS Max qqqqq 移动联通电信4G手机  64GB ', 0, 0, 0, 1, 1),
       (309, 18, '内存:256GB', 0.00, 0.00, 0, NULL, '2019-04-26 11:26:47', '2019-04-26 11:26:47', NULL, NULL, NULL,
        '256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  256GB ', 0, 0, 0, 1, 1),
       (310, 18, '版本:公开版;颜色:金色;内存:64GB', 0.00, 10.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL, NULL,
        NULL, '公开版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 64GB ', 0, 0, 0, 0, 0),
       (311, 18, '版本:换修无忧版;颜色:金色;内存:64GB', 0.00, 9.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '换修无忧版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 64GB ', 0, 0, 0, 0, 0),
       (312, 18, '版本:原厂延保版;颜色:金色;内存:64GB', 0.00, 8.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '原厂延保版 金色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 金色 64GB ', 0, 0, 0, 0, 0),
       (313, 18, '版本:公开版;颜色:深空灰色;内存:64GB', 0.00, 7.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '公开版 深空灰色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 64GB ', 0, 0, 0, 0, 0),
       (314, 18, '版本:换修无忧版;颜色:深空灰色;内存:64GB', 0.00, 1.01, 81, NULL, '2019-07-03 17:17:56', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/2cd9ec641d92458983c00d87ff33ad57.jpg', '换修无忧版 深空灰色 64GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 64GB ', 55, 0, 0, 1, 0),
       (315, 18, '版本:原厂延保版;颜色:深空灰色;内存:64GB', 0.00, 1.02, 0, NULL, '2019-04-29 19:41:13', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/bf4c40f7e6e5454e806c244ca49d3964.jpg', '原厂延保版 深空灰色 64GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 深空灰色 64GB ', 2, 0, 0, 1, 0),
       (316, 18, '版本:公开版;颜色:银色;内存:64GB', 0.00, 7102.00, 1, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '公开版 银色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 银色 64GB ', 0, 0, 0, 1, 0),
       (317, 18, '版本:换修无忧版;颜色:银色;内存:64GB', 0.00, 7103.00, 1, NULL, '2019-07-03 17:15:41', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '换修无忧版 银色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 64GB ', 1, 0, 0, 1, 0),
       (318, 18, '版本:原厂延保版;颜色:银色;内存:64GB', 0.00, 7104.00, 1, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '原厂延保版 银色 64GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 银色 64GB ', 0, 0, 0, 1, 0),
       (319, 18, '版本:公开版;颜色:金色;内存:256GB', 0.00, 7600.00, 1, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/1cfc26bed5084caaa439ed4e49b41885.jpg', '公开版 金色 256GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 256GB ', 0, 0, 0, 1, 0),
       (320, 18, '版本:换修无忧版;颜色:金色;内存:256GB', 0.00, 7601.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/a25a877f99684e1882eef5a5bb9081c4.jpg', '换修无忧版 金色 256GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 256GB ', 0, 0, 0, 1, 0),
       (321, 18, '版本:原厂延保版;颜色:金色;内存:256GB', 0.00, 7602.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/b119c50832d44622a07c7ed0ff10f647.jpg', '原厂延保版 金色 256GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 金色 256GB ', 0, 0, 0, 1, 0),
       (322, 18, '版本:公开版;颜色:深空灰色;内存:256GB', 0.00, 7603.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/98b8c67212994d9bb62ac35aedd1cc08.jpg', '公开版 深空灰色 256GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 256GB ', 0, 0, 0, 1, 0),
       (323, 18, '版本:换修无忧版;颜色:深空灰色;内存:256GB', 0.00, 7604.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06',
        NULL, NULL, '2019/04/e5cdcd2c310d4cf2b702523db1993dbd.jpg', '换修无忧版 深空灰色 256GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 256GB ', 0, 0, 0, 1, 0),
       (324, 18, '版本:原厂延保版;颜色:深空灰色;内存:256GB', 0.00, 7605.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06',
        NULL, NULL, '2019/04/9edd1e5a57d345678dd52308496457bb.jpg', '原厂延保版 深空灰色 256GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 深空灰色 256GB ', 0, 0, 0, 1, 0),
       (325, 18, '版本:公开版;颜色:银色;内存:256GB', 0.00, 7606.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '公开版 银色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 银色 256GB ', 0, 0, 0, 1, 0),
       (326, 18, '版本:换修无忧版;颜色:银色;内存:256GB', 0.00, 7607.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '换修无忧版 银色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 256GB ', 0, 0, 0, 1, 0),
       (327, 18, '版本:原厂延保版;颜色:银色;内存:256GB', 0.00, 7608.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '原厂延保版 银色 256GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 银色 256GB ', 0, 0, 0, 1, 0),
       (328, 18, '版本:公开版;颜色:金色;内存:512GB', 0.00, 8000.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/20824781b8f24771b12cf273450aaaae.jpg', '公开版 金色 512GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  公开版 金色 512GB ', 0, 0, 0, 1, 0),
       (329, 18, '版本:换修无忧版;颜色:金色;内存:512GB', 0.00, 8001.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/2c60b3e379e84d6bacfd7f04edc1a653.jpg', '换修无忧版 金色 512GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 金色 512GB ', 0, 0, 0, 1, 0),
       (330, 18, '版本:原厂延保版;颜色:金色;内存:512GB', 0.00, 8002.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/2e5239d4fd6e49e29c9f8e75edad7318.jpg', '原厂延保版 金色 512GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 金色 512GB ', 0, 0, 0, 1, 0),
       (331, 18, '版本:公开版;颜色:深空灰色;内存:512GB', 0.00, 8003.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, '2019/04/525b9161f2424645bab7ca1b73e918d2.jpg', '公开版 深空灰色 512GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  公开版 深空灰色 512GB ', 0, 0, 0, 1, 0),
       (332, 18, '版本:换修无忧版;颜色:深空灰色;内存:512GB', 0.00, 8004.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06',
        NULL, NULL, '2019/04/a5dd840eadaa41afadfd7d16ed05b139.jpg', '换修无忧版 深空灰色 512GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 深空灰色 512GB ', 0, 0, 0, 1, 0),
       (333, 18, '版本:原厂延保版;颜色:深空灰色;内存:512GB', 0.00, 8006.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06',
        NULL, NULL, '2019/04/ae2c5c3b77e0437c93114cae3bfb20e0.jpg', '原厂延保版 深空灰色 512GB ',
        'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 深空灰色 512GB ', 0, 0, 0, 1, 0),
       (334, 18, '版本:公开版;颜色:银色;内存:512GB', 0.00, 8000.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '公开版 银色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  公开版 银色 512GB ', 0, 0, 0, 0, 0),
       (335, 18, '版本:换修无忧版;颜色:银色;内存:512GB', 0.00, 8005.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '换修无忧版 银色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  换修无忧版 银色 512GB ', 0, 0, 0, 1, 0),
       (336, 18, '版本:原厂延保版;颜色:银色;内存:512GB', 0.00, 8000.00, 0, NULL, '2019-04-26 11:40:06', '2019-04-26 11:40:06', NULL,
        NULL, NULL, '原厂延保版 银色 512GB ', 'Apple iPhone XS Max 移动联通电信4G手机  原厂延保版 银色 512GB ', 0, 0, 0, 0, 0),
       (337, 70, '', 0.00, 0.00, 0, NULL, '2019-04-26 11:40:24', '2019-04-26 11:40:24', NULL, NULL, NULL, '', '面包面包', 0,
        0, 0, 1, 1),
       (338, 70, '', 2.00, 1.00, 3, NULL, '2019-04-26 13:40:59', '2019-04-26 13:40:59', NULL, NULL, NULL, '', '面包面包', 0,
        4, 5, 1, 1),
       (339, 70, '版本:公开版', 0.00, 0.00, 0, NULL, '2019-04-26 14:21:12', '2019-04-26 14:21:12', NULL, NULL, NULL, '公开版 ',
        '面包面包11 公开版 ', 0, 0, 0, 1, 1),
       (340, 70, '版本:换修无忧版', 0.00, 0.00, 0, NULL, '2019-04-26 14:21:12', '2019-04-26 14:21:12', NULL, NULL, NULL,
        '换修无忧版 ', '面包面包11 换修无忧版 ', 0, 0, 0, 1, 1),
       (341, 70, '版本:公开版', 2.00, 1.00, 3, NULL, '2019-04-26 14:21:33', '2019-04-26 14:21:33', NULL, NULL,
        '2019/04/c6b85c1bce184dfebaceb9352e1bba2c.jpg', '公开版 ', '面包面包111 公开版 ', 0, 0, 0, 0, 1),
       (342, 70, '版本:换修无忧版', 5.00, 4.00, 6, NULL, '2019-04-26 14:21:33', '2019-04-26 14:21:33', NULL, NULL, NULL,
        '换修无忧版 ', '面包面包111 换修无忧版 ', 0, 0, 0, 1, 1),
       (343, 70, '', 2.00, 1.00, 3, NULL, '2019-04-26 15:14:04', '2019-04-26 15:14:04', NULL, NULL, NULL, '', '面包面包', 0,
        4, 5, 1, 1),
       (344, 70, '馅料:绿豆馅', 0.00, 0.00, 0, NULL, '2019-04-26 15:15:44', '2019-04-26 15:15:44', NULL, NULL, NULL, '绿豆馅 ',
        '面包面包 绿豆馅 ', 0, 0, 0, 1, 1),
       (345, 70, '馅料:红豆馅', 0.00, 0.00, 0, NULL, '2019-04-26 15:15:44', '2019-04-26 15:15:44', NULL, NULL, NULL, '红豆馅 ',
        '面包面包 红豆馅 ', 0, 0, 0, 1, 1),
       (346, 72, '尺寸:40*50;外框类型:曜石黑金属画框;颜色分类:金色', 0.00, 169.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, '2019/04/2ae8beb3fb7445589754ad959482c186.jpg', '40*50 曜石黑金属画框 金色 ',
        '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 曜石黑金属画框 金色 ', 0, 0, 0, 1, 0),
       (347, 72, '尺寸:50*60;外框类型:曜石黑金属画框;颜色分类:金色', 0.00, 175.00, 6, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 曜石黑金属画框 金色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 曜石黑金属画框 金色 ', 0, 0, 0, 1, 0),
       (348, 72, '尺寸:60*80;外框类型:曜石黑金属画框;颜色分类:金色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 曜石黑金属画框 金色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 曜石黑金属画框 金色 ', 0, 0, 0, 1, 0),
       (349, 72, '尺寸:40*50;外框类型:流砂金金属画框;颜色分类:金色', 0.00, 169.00, 3, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, '2019/04/26bf2e07ecbf41b6a67029acb8f22cfc.jpg', '40*50 流砂金金属画框 金色 ',
        '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 流砂金金属画框 金色 ', 0, 0, 0, 1, 0),
       (350, 72, '尺寸:50*60;外框类型:流砂金金属画框;颜色分类:金色', 0.00, 175.00, 3, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 流砂金金属画框 金色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 流砂金金属画框 金色 ', 0, 0, 0, 1, 0),
       (351, 72, '尺寸:60*80;外框类型:流砂金金属画框;颜色分类:金色', 0.00, 182.00, 3, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 流砂金金属画框 金色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 流砂金金属画框 金色 ', 0, 0, 0, 1, 0),
       (352, 72, '尺寸:40*50;外框类型:轻奢金画框;颜色分类:金色', 0.00, 169.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 轻奢金画框 金色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 轻奢金画框 金色 ', 0, 0, 0, 1, 0),
       (353, 72, '尺寸:50*60;外框类型:轻奢金画框;颜色分类:金色', 0.00, 175.00, 6, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 轻奢金画框 金色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 轻奢金画框 金色 ', 0, 0, 0, 1, 0),
       (354, 72, '尺寸:60*80;外框类型:轻奢金画框;颜色分类:金色', 0.00, 179.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 轻奢金画框 金色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 轻奢金画框 金色 ', 0, 0, 0, 1, 0),
       (355, 72, '尺寸:40*50;外框类型:曜石黑金属画框;颜色分类:粉红色', 0.00, 169.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 曜石黑金属画框 粉红色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 曜石黑金属画框 粉红色 ', 0, 0, 0, 1, 0),
       (356, 72, '尺寸:50*60;外框类型:曜石黑金属画框;颜色分类:粉红色', 0.00, 175.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, '2019/04/8bd6d1e21886429f87f9964c338efee8.jpg', '50*60 曜石黑金属画框 粉红色 ',
        '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 曜石黑金属画框 粉红色 ', 0, 0, 0, 1, 0),
       (357, 72, '尺寸:60*80;外框类型:曜石黑金属画框;颜色分类:粉红色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 曜石黑金属画框 粉红色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 曜石黑金属画框 粉红色 ', 0, 0, 0, 1, 0),
       (358, 72, '尺寸:40*50;外框类型:流砂金金属画框;颜色分类:粉红色', 0.00, 169.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 流砂金金属画框 粉红色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 流砂金金属画框 粉红色 ', 0, 0, 0, 1, 0),
       (359, 72, '尺寸:50*60;外框类型:流砂金金属画框;颜色分类:粉红色', 0.00, 175.00, 6, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 流砂金金属画框 粉红色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 流砂金金属画框 粉红色 ', 0, 0, 0, 1, 0),
       (360, 72, '尺寸:60*80;外框类型:流砂金金属画框;颜色分类:粉红色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 流砂金金属画框 粉红色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 流砂金金属画框 粉红色 ', 0, 0, 0, 1, 0),
       (361, 72, '尺寸:40*50;外框类型:轻奢金画框;颜色分类:粉红色', 0.00, 169.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, '2019/04/41f7b496551149e185f92e36bb4aff79.jpg', '40*50 轻奢金画框 粉红色 ',
        '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 轻奢金画框 粉红色 ', 0, 0, 0, 1, 0),
       (362, 72, '尺寸:50*60;外框类型:轻奢金画框;颜色分类:粉红色', 0.00, 175.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 轻奢金画框 粉红色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 轻奢金画框 粉红色 ', 0, 0, 0, 1, 0),
       (363, 72, '尺寸:60*80;外框类型:轻奢金画框;颜色分类:粉红色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 轻奢金画框 粉红色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 轻奢金画框 粉红色 ', 0, 0, 0, 1, 0),
       (364, 72, '尺寸:40*50;外框类型:曜石黑金属画框;颜色分类:银色', 0.00, 169.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 曜石黑金属画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 曜石黑金属画框 银色 ', 0, 0, 0, 1, 0),
       (365, 72, '尺寸:50*60;外框类型:曜石黑金属画框;颜色分类:银色', 0.00, 175.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 曜石黑金属画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 曜石黑金属画框 银色 ', 0, 0, 0, 1, 0),
       (366, 72, '尺寸:60*80;外框类型:曜石黑金属画框;颜色分类:银色', 0.00, 182.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 曜石黑金属画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 曜石黑金属画框 银色 ', 0, 0, 0, 1, 0),
       (367, 72, '尺寸:40*50;外框类型:流砂金金属画框;颜色分类:银色', 0.00, 169.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 流砂金金属画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 流砂金金属画框 银色 ', 0, 0, 0, 1, 0),
       (368, 72, '尺寸:50*60;外框类型:流砂金金属画框;颜色分类:银色', 0.00, 175.00, 3, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 流砂金金属画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 流砂金金属画框 银色 ', 0, 0, 0, 1, 0),
       (369, 72, '尺寸:60*80;外框类型:流砂金金属画框;颜色分类:银色', 0.00, 182.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 流砂金金属画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 流砂金金属画框 银色 ', 0, 0, 0, 1, 0),
       (370, 72, '尺寸:40*50;外框类型:轻奢金画框;颜色分类:银色', 0.00, 169.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 轻奢金画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 轻奢金画框 银色 ', 0, 0, 0, 1, 0),
       (371, 72, '尺寸:50*60;外框类型:轻奢金画框;颜色分类:银色', 0.00, 175.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 轻奢金画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 轻奢金画框 银色 ', 0, 0, 0, 1, 0),
       (372, 72, '尺寸:60*80;外框类型:轻奢金画框;颜色分类:银色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 轻奢金画框 银色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 轻奢金画框 银色 ', 0, 0, 0, 1, 0),
       (373, 72, '尺寸:40*50;外框类型:曜石黑金属画框;颜色分类:暗黑色', 0.00, 169.00, 0, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 曜石黑金属画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 曜石黑金属画框 暗黑色 ', 0, 0, 0, 1, 0),
       (374, 72, '尺寸:50*60;外框类型:曜石黑金属画框;颜色分类:暗黑色', 0.00, 175.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 曜石黑金属画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 曜石黑金属画框 暗黑色 ', 0, 0, 0, 1, 0),
       (375, 72, '尺寸:60*80;外框类型:曜石黑金属画框;颜色分类:暗黑色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 曜石黑金属画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 曜石黑金属画框 暗黑色 ', 0, 0, 0, 1, 0),
       (376, 72, '尺寸:40*50;外框类型:流砂金金属画框;颜色分类:暗黑色', 0.00, 169.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 流砂金金属画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 流砂金金属画框 暗黑色 ', 0, 0, 0, 0, 0),
       (377, 72, '尺寸:50*60;外框类型:流砂金金属画框;颜色分类:暗黑色', 0.00, 175.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 流砂金金属画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 流砂金金属画框 暗黑色 ', 0, 0, 0, 1, 0),
       (378, 72, '尺寸:60*80;外框类型:流砂金金属画框;颜色分类:暗黑色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 流砂金金属画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 流砂金金属画框 暗黑色 ', 0, 0, 0, 1, 0),
       (379, 72, '尺寸:40*50;外框类型:轻奢金画框;颜色分类:暗黑色', 0.00, 169.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '40*50 轻奢金画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 40*50 轻奢金画框 暗黑色 ', 0, 0, 0, 1, 0),
       (380, 72, '尺寸:50*60;外框类型:轻奢金画框;颜色分类:暗黑色', 0.00, 175.00, 4, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '50*60 轻奢金画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 50*60 轻奢金画框 暗黑色 ', 0, 0, 0, 0, 0),
       (381, 72, '尺寸:60*80;外框类型:轻奢金画框;颜色分类:暗黑色', 0.00, 182.00, 5, NULL, '2019-04-26 17:01:57', '2019-04-26 17:01:57',
        NULL, NULL, NULL, '60*80 轻奢金画框 暗黑色 ', '餐厅装饰画现代简约饭厅挂画墙面壁画好好吃饭 60*80 轻奢金画框 暗黑色 ', 0, 0, 0, 1, 0),
       (382, 71, '颜色:真爱粉;尺寸:3.5英寸', 0.00, 0.00, 0, NULL, '2019-04-26 17:49:28', '2019-04-26 17:49:28', NULL, NULL,
        '2019/04/e50714c046364201a49120774f12b664.jpg', '真爱粉 3.5英寸 ', '旗舰店官网 自拍神器 梵高定制 真爱粉 3.5英寸 ', 0, 0, 0, 1, 1),
       (383, 71, '颜色:心水金;尺寸:3.5英寸', 0.00, 0.00, 0, NULL, '2019-04-26 17:49:28', '2019-04-26 17:49:28', NULL, NULL,
        '2019/04/55121264771049828f024c3d79070381.jpg', '心水金 3.5英寸 ', '旗舰店官网 自拍神器 梵高定制 心水金 3.5英寸 ', 0, 0, 0, 1, 1),
       (384, 71, '颜色:心水金;尺寸:3.6 寸', 0.00, 6999.00, 100, NULL, '2019-04-26 18:02:37', '2019-04-26 18:02:37', NULL, NULL,
        '2019/04/a570dfccaedd45adbb91cbfb2e1c5553.jpg', '心水金 3.6 寸 ', '旗舰店官网 自拍神器 梵高定制 心水金 3.6 寸 ', 0, 0, 0, 1, 0),
       (385, 71, '颜色:真爱粉;尺寸:3.6 寸', 0.00, 6998.00, 79, NULL, '2019-06-24 09:36:33', '2019-04-26 18:02:37', NULL, NULL,
        '2019/04/17ba70d217644839a381df0dc3682b11.jpg', '真爱粉 3.6 寸 ', '旗舰店官网 自拍神器 梵高定制 真爱粉 3.6 寸 ', 11, 0, 0, 1, 0),
       (386, 70, '馅料:绿豆馅', 0.00, 0.00, 0, NULL, '2019-04-26 18:03:32', '2019-04-26 18:03:32', NULL, NULL, NULL, '绿豆馅 ',
        '面包面包', 0, 0, 0, 1, 1),
       (387, 70, '馅料:绿豆馅', 0.00, 0.00, 0, NULL, '2019-04-26 18:04:39', '2019-04-26 18:04:39', NULL, NULL, NULL, '绿豆馅 ',
        '面包面包', 0, 0, 0, 1, 1),
       (388, 70, '馅料:绿豆馅', 0.00, 0.00, 0, NULL, '2019-04-26 18:05:18', '2019-04-26 18:05:18', NULL, NULL, NULL, '绿豆馅 ',
        '面包面包', 0, 0, 0, 1, 1),
       (389, 70, '馅料:绿豆馅', 0.00, 0.00, 0, NULL, '2019-04-26 18:06:04', '2019-04-26 18:06:04', NULL, NULL, NULL, '绿豆馅 ',
        '面包面包 绿豆馅 ', 0, 0, 0, 1, 1),
       (390, 70, '馅料:111', 0.00, 0.00, 0, NULL, '2019-04-26 18:06:04', '2019-04-26 18:06:04', NULL, NULL, NULL, '111 ',
        '面包面包 111 333', 0, 0, 0, 1, 1),
       (391, 70, '馅料:222', 0.00, 0.00, 0, NULL, '2019-04-26 18:06:04', '2019-04-26 18:06:04', NULL, NULL, NULL, '222 ',
        '面包面包 222 ', 0, 0, 0, 1, 1),
       (392, 70, '馅料:绿豆馅', 0.00, 0.00, 0, NULL, '2019-04-26 18:06:15', '2019-04-26 18:06:15', NULL, NULL, NULL, '绿豆馅 ',
        '面包面包', 0, 0, 0, 1, 1),
       (393, 59, '化妆品含量:400ml', 450.00, 420.00, 62, NULL, '2019-04-26 19:04:28', '2019-04-26 19:04:28', NULL, NULL,
        '2019/04/8ba6bde1cce04d5fb235d700e4dcfbef.jpg', '400ml ', '兰蔻粉水清滢柔肤水400ml 爽肤水女保湿舒缓滋润嫩肤', 0, 0, 0, 1, 0),
       (394, 69, '鞋码:41;颜色分类:原灰白/浅灰/蒸汽绿', 0.00, 1199.00, 3, NULL, '2019-04-26 19:20:31', '2019-04-26 19:20:31', NULL,
        NULL, '2019/04/ac107d12d30e4279b53957fcac7e12e2.jpg', '41 原灰白/浅灰/蒸汽绿 ',
        '阿迪达斯官方 adidas 三叶草 NITE JOGGER 男子经典鞋BD7956 41 原灰白/浅灰/蒸汽绿 ', 0, 0, 0, 1, 0),
       (395, 69, '鞋码:42;颜色分类:原灰白/浅灰/蒸汽绿', 0.00, 1199.00, 5, NULL, '2019-04-26 19:20:31', '2019-04-26 19:20:31', NULL,
        NULL, '2019/04/73acdb3c367f4c66960d579b70da5b93.jpg', '42 原灰白/浅灰/蒸汽绿 ',
        '阿迪达斯官方 adidas 三叶草 NITE JOGGER 男子经典鞋BD7956 42 原灰白/浅灰/蒸汽绿 ', 0, 0, 0, 1, 0),
       (396, 69, '鞋码:42.5;颜色分类:原灰白/浅灰/蒸汽绿', 0.00, 1199.00, 5, NULL, '2019-04-26 19:20:31', '2019-04-26 19:20:31', NULL,
        NULL, '2019/04/e57dcc9f1d74498cb11c0a3ceb3c9785.jpg', '42.5 原灰白/浅灰/蒸汽绿 ',
        '阿迪达斯官方 adidas 三叶草 NITE JOGGER 男子经典鞋BD7956 42.5 原灰白/浅灰/蒸汽绿 ', 0, 0, 0, 1, 0),
       (397, 69, '鞋码:43;颜色分类:原灰白/浅灰/蒸汽绿', 0.00, 1199.00, 7, NULL, '2019-04-26 19:20:31', '2019-04-26 19:20:31', NULL,
        NULL, '2019/04/90ff942af7c949d2a00e4e83c4c24ce7.jpg', '43 原灰白/浅灰/蒸汽绿 ',
        '阿迪达斯官方 adidas 三叶草 NITE JOGGER 男子经典鞋BD7956 43 原灰白/浅灰/蒸汽绿 ', 0, 0, 0, 1, 0),
       (398, 69, '鞋码:43.5;颜色分类:原灰白/浅灰/蒸汽绿', 0.00, 1199.00, 7, NULL, '2019-04-26 19:20:31', '2019-04-26 19:20:31', NULL,
        NULL, '2019/04/01c585d96f2b4e2b9693833e859afd49.jpg', '43.5 原灰白/浅灰/蒸汽绿 ',
        '阿迪达斯官方 adidas 三叶草 NITE JOGGER 男子经典鞋BD7956 43.5 原灰白/浅灰/蒸汽绿 ', 0, 0, 0, 1, 0),
       (399, 70, '', 0.00, 38.00, 15, NULL, '2019-04-26 20:56:19', '2019-04-26 20:56:19', NULL, NULL, NULL, '',
        '【Dole都乐】比利时Truval啤梨12只 进口水果新鲜梨 单果120g左右', 0, 0, 0, 1, 0),
       (400, 73, '规格:芒果味 184克', 0.00, 22.00, 82, 10, '2019-06-24 14:52:28', '2019-04-27 11:37:12', NULL, NULL,
        '2019/04/8de2ccaa66874d42986c73692b25f441.jpg', '芒果味 184克 ', '阴阳师寮办秘制 月见和菓子 184克', 22, 0, 0, 1, 0),
       (401, 74, '', 120.00, 100.00, 100, NULL, '2019-05-22 10:39:51', '2019-05-22 10:39:51', NULL, NULL, NULL, '',
        '旺仔牛奶', 0, 1, 1, 1, 0),
       (402, 75, '', 30.00, 30.00, 30, NULL, '2019-06-19 20:25:10', '2019-05-23 17:23:12', NULL, NULL, NULL, '',
        '测试商品A', 5, 0, 0, 1, 0),
       (403, 76, '', 40.00, 40.00, 40, NULL, '2019-06-24 14:53:48', '2019-05-23 17:24:06', NULL, NULL, NULL, '',
        '测试商品B', 5, 0, 0, 1, 0),
       (404, 77, '', 60.00, 50.00, 50, NULL, '2019-05-23 17:24:48', '2019-05-23 17:24:48', NULL, NULL, NULL, '',
        '测试商品C', 0, 0, 0, 1, 0);
...
insert into `tz_sms_log`(`id`, `user_id`, `user_phone`, `content`, `mobile_code`, `type`, `rec_date`, `response_code`,
                         `status`)
values (15, '25477c53-6f67-4309-9e10-a26876ebfddb', '13726236870', '感谢您对xxx的支持。您的验证码是129619，请勿把验证码泄漏给第三方。', '129619', 0,
        '2019-04-24 11:20:29', NULL, 0);
...
insert into `tz_sys_log`(`id`, `username`, `operation`, `method`, `params`, `time`, `ip`, `create_date`)
values (829, 'admin', '保存定时任务', 'com.yami.shop.quartz.controller.ScheduleJobController.save()',
        '{\"jobId\":14,\"beanName\":\"orderTask\",\"methodName\":\"cancelOrder\",\"cronExpression\":\"0 * * * * ?\",\"status\":0,\"remark\":\"取消超时未支付订单\",\"createTime\":\"2019-06-24T06:51:51.074+0000\"}',
        167, '127.0.0.1', '2019-06-24 14:51:51'),
       (830, 'admin', '保存定时任务', 'com.yami.shop.quartz.controller.ScheduleJobController.save()',
        '{\"jobId\":16,\"beanName\":\"orderTask\",\"methodName\":\"confirmOrder\",\"cronExpression\":\"0 0/5 * * * ?\",\"status\":0,\"remark\":\"系统自动确认收货订单\",\"createTime\":\"2019-06-24T06:52:47.482+0000\"}',
        62, '127.0.0.1', '2019-06-24 14:52:48'),
       (831, 'admin', '删除菜单', 'com.yami.shop.sys.controller.SysMenuController.delete()', '168', 8, '127.0.0.1',
        '2019-06-26 14:04:22'),
       (832, 'admin', '删除菜单', 'com.yami.shop.sys.controller.SysMenuController.delete()', '229', 1, '127.0.0.1',
        '2019-06-26 14:31:31'),
       (833, 'admin', '删除菜单', 'com.yami.shop.sys.controller.SysMenuController.delete()', '231', 6, '127.0.0.1',
        '2019-06-26 14:31:37'),
       (834, 'admin', '删除菜单', 'com.yami.shop.sys.controller.SysMenuController.delete()', '232', 8, '127.0.0.1',
        '2019-06-26 14:31:38'),
       (835, 'admin', '删除菜单', 'com.yami.shop.sys.controller.SysMenuController.delete()', '233', 25, '127.0.0.1',
        '2019-06-26 14:31:42'),
       (836, 'admin', '删除菜单', 'com.yami.shop.sys.controller.SysMenuController.delete()', '229', 6, '127.0.0.1',
        '2019-06-26 14:31:46'),
       (837, 'admin', '删除分类', 'com.yami.shop.admin.controller.CategoryController.delete()', '92', 536, '127.0.0.1',
        '2019-07-01 11:14:38'),
       (838, 'admin', '保存角色', 'com.yami.shop.sys.controller.SysRoleController.save()',
        '{\"roleId\":1,\"roleName\":\"管理员\",\"remark\":\"测试\",\"menuIdList\":[34,70,71,72,73,74,75,136,137,138,139,140,239,240,241,242,243,306,307,308,309,310,51,57,58,59,60,63,300,301,302,303,305,131,132,133,134,135,163,164,165,166,167,174,175,176,177,178,201,202,203,204,205,206,125,126,127,128,129,130,230,91,92,93,99,100,101,107,108,146,184,185,1,312,313,314,315,316,2,15,16,17,18,3,19,20,21,22,4,23,24,25,26,6,7,8,9,10,11,12,13,14,27,29,-666666],\"createTime\":\"2019-07-03T00:39:49.339+0000\"}',
        106, '127.0.0.1', '2019-07-03 08:39:49'),
       (839, 'admin', '保存配置', 'com.yami.shop.sys.controller.SysConfigController.save()',
        '{\"id\":1,\"paramKey\":\"测试\",\"paramValue\":\"1\",\"remark\":\"1\"}', 17, '127.0.0.1', '2019-07-03 08:57:59'),
       (840, 'admin', '删除配置', 'com.yami.shop.sys.controller.SysConfigController.delete()', '[1]', 18, '127.0.0.1',
        '2019-07-03 08:58:20'),
       (841, 'admin', '新增公告管理', 'com.yami.shop.admin.controller.NoticeController.save()',
        '{\"id\":4,\"shopId\":1,\"title\":\"测试\",\"content\":\"<p>1111</p>\",\"status\":1,\"isTop\":1,\"publishTime\":\"2019-07-03T02:05:55.730+0000\",\"updateTime\":\"2019-07-03T02:05:55.730+0000\"}',
        26, '127.0.0.1', '2019-07-03 10:05:56'),
       (842, 'admin', '删除公告管理', 'com.yami.shop.admin.controller.NoticeController.removeById()', '4', 37, '127.0.0.1',
        '2019-07-03 20:00:24'),
       (843, 'admin', '修改定时任务', 'com.yami.shop.quartz.controller.ScheduleJobController.update()',
        '{\"jobId\":14,\"beanName\":\"orderTask\",\"methodName\":\"cancelOrder\",\"cronExpression\":\"0 * * * * ?\",\"status\":0,\"remark\":\"取消超时未支付订单\"}',
        50, '127.0.0.1', '2019-08-07 17:01:52'),
       (844, 'admin', '修改定时任务', 'com.yami.shop.quartz.controller.ScheduleJobController.update()',
        '{\"jobId\":16,\"beanName\":\"orderTask\",\"methodName\":\"confirmOrder\",\"cronExpression\":\"0 0/5 * * * ?\",\"status\":0,\"remark\":\"系统自动确认收货订单\"}',
        18, '127.0.0.1', '2019-08-07 17:01:57'),
       (845, 'admin', '立即执行任务', 'com.yami.shop.quartz.controller.ScheduleJobController.run()', '[14]', 14, '127.0.0.1',
        '2019-08-07 17:02:06');
...
values (1, 0, '系统管理', '', '', 0, 'system', 3),
       ...
       (27, 1, '参数管理', 'sys/config',
        'sys:config:page,sys:config:info,sys:config:save,sys:config:update,sys:config:delete', 1, 'config', 6),
       ...
       (164, 163, '查看', '',
        'shop:transport:page,shop:shopDetail:info,shop:transfee:info,admin:area:page,shop:transcity:info', 2, '', 0),
...
insert into `tz_sys_role`(`role_id`, `role_name`, `remark`, `create_user_id`, `create_time`)
values (1, '管理员', '测试', NULL, '2019-07-03 08:39:49');
...
insert into `tz_sys_role_menu`(`id`, `role_id`, `menu_id`)
values (1, 1, 34),
       (2, 1, 70),
       (3, 1, 71),
       (4, 1, 72),
...
insert into `tz_sys_user`(`user_id`, `username`, `password`, `email`, `mobile`, `status`, `create_user_id`,
                          `create_time`, `shop_id`)
values (1, 'admin', '{bcrypt}$2a$10$AV9Xz.3ck4RsXiad5ArcBO5.ZKwlpcnJzs740BHY..fsSp0PnM/Zu', 'root@123.com',
        '13612345678', 1, 1, '2016-11-11 11:11:11', 1);
...
insert into `tz_transcity`(`transcity_id`, `transfee_id`, `city_id`)
values (655, 119, 440118000000),
...
insert into `tz_transcity_free`(`transcity_free_id`, `transfee_free_id`, `free_city_id`)
values (18, NULL, 52994),
       (19, NULL, 52995),
       (339, 32, 2376),
       (1351, 49, 72),
       (1352, 49, 2800),
...
insert into `tz_transfee`(`transfee_id`, `transport_id`, `continuous_piece`, `first_piece`, `continuous_fee`,
                          `first_fee`)
values (101, 50, 0.02, 0.01, 1.00, 2.00),
...
insert into `tz_transfee_free`(`transfee_free_id`, `transport_id`, `free_type`, `amount`, `piece`)
values (32, 53, 1, 88.00, NULL),
       (49, 67, 0, NULL, 1.75),
       (51, 68, 0, NULL, 3.50),
       (58, 56, 0, NULL, 10.00),
       (59, 56, 1, 10.00, NULL),
...
insert into `tz_transport`(`transport_id`, `trans_name`, `create_time`, `shop_id`, `charge_type`, `is_free_fee`,
                           `has_free_condition`)
values (47, '包邮', '2018-11-21 17:17:07', 1, 0, 1, 0),
...
insert into `tz_user`(`user_id`, `nick_name`, `real_name`, `user_mail`, `login_password`, `pay_password`, `user_mobile`,
                      `modify_time`, `user_regtime`, `user_regip`, `user_lasttime`, `user_lastip`, `user_memo`, `sex`,
                      `birth_date`, `pic`, `status`, `score`)
values ('51540df5255e4d22903b0f83921095ff', '.', '', NULL, NULL, NULL, NULL, '2019-06-26 14:37:04',
        '2019-06-26 14:37:04', NULL, NULL, NULL, NULL, 'M', NULL,
        'https://wx.qlogo.cn/mmopen/vi_32/krmdRqHOnNAFoGzW2Ssy6pmzAMQryWphiaDZU5AsAR0AMvuLzlcBLtjEe8VlUAMIiah8juTPWa839BnOn1C0Oykg/132',
        1, NULL),
       ('5f159317be5b4dc4bf3188f1a3da0369', 'Leo', '', NULL, NULL, NULL, NULL, '2019-07-02 10:56:53',
        '2019-07-02 10:56:53', NULL, NULL, NULL, NULL, 'M', NULL,
        'https://wx.qlogo.cn/mmopen/vi_32/hOM3grD77lIBdbdY0UXg4ql4NI1BeyJxlh1gPxgdnMbGzWCicahV4Ukt0pRkmo068d5CaSlM76xDrDDAsYFje6Q/132',
        1, NULL);
...
insert into `tz_user_addr`(`addr_id`, `user_id`, `receiver`, `province_id`, `province`, `city`, `city_id`, `area`,
                           `area_id`, `post_code`, `addr`, `mobile`, `status`, `common_addr`, `create_time`, `version`,
                           `update_time`)
values (3, '51540df5255e4d22903b0f83921095ff', 'user', 110000000000, '北京市', '市辖区', 110100000000, '东城区', 110101000000,
        NULL, 'b613', '15000000000', 1, 1, '2019-07-01 18:05:53', 0, '2019-07-01 18:05:53');
...
insert into `tz_user_addr_order`(`addr_order_id`, `addr_id`, `user_id`, `receiver`, `province_id`, `province`,
                                 `area_id`, `area`, `city_id`, `city`, `addr`, `post_code`, `mobile`, `create_time`,
                                 `version`)
values (1, 3, '51540df5255e4d22903b0f83921095ff', 'user', 110000000000, '北京市', 110101000000, '东城区', 110100000000, '市辖区',
        'b613', NULL, '15000000000', '2019-07-01 18:07:11', 0),
       (2, 3, '51540df5255e4d22903b0f83921095ff', 'user', 110000000000, '北京市', 110101000000, '东城区', 110100000000, '市辖区',
        'b613', NULL, '15000000000', '2019-07-03 17:13:06', 0),
       (3, 3, '51540df5255e4d22903b0f83921095ff', 'user', 110000000000, '北京市', 110101000000, '东城区', 110100000000, '市辖区',
        'b613', NULL, '15000000000', '2019-07-03 17:15:41', 0),
       (5, 3, '51540df5255e4d22903b0f83921095ff', 'user', 110000000000, '北京市', 110101000000, '东城区', 110100000000, '市辖区',
        'b613', NULL, '15000000000', '2019-07-03 17:16:36', 0),
       (6, 3, '51540df5255e4d22903b0f83921095ff', 'user', 110000000000, '北京市', 110101000000, '东城区', 110100000000, '市辖区',
        'b613', NULL, '15000000000', '2019-07-03 17:17:56', 0);
